  ...
  q:{
    ...
    db:[
      ...
      {l:"medium",tag:"concept",q:"What store holds current positions, and what's the schema?",turns:[
        ...
        {who:"intv",text:"No history at all? Uber clearly stores trip history somewhere."},
        {who:"cand",text:"Right, but not <em>here</em>. This store is the live-positions hot path and must stay lean. Historical trails, analytics, and billing go to a separate durable pipeline — updates fan out asynchronously to Kafka and land in a data warehouse / time-series store off the critical path. Mixing durable history into the hot positions store would slow the 250K/s write path for data the matching query never reads. Separation of concerns: ephemeral-and-fast here, durable-and-slow over there."},
      ],resources:[
        {title:"Redis geospatial data type",url:"https://redis.io/docs/latest/develop/data-types/geospatial/"},
